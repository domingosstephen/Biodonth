...
export function SobreIntegrated() {
  const { integrated } = SOBRE_PAGE;
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 xl:gap-20">
          ...
          >
            ...
            <motion.div variants={FADE_UP} transition={TRANSITION_DEFAULT}>
              <DisplayHeadline bronze={integrated.bronze} bronzeItalic={integrated.bronzeItalic} align="left" />
            </motion.div>
