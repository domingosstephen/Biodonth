...
export function PrevencaoPageHero() {
  const { hero, breadcrumb } = PREVENCAO_PAGE;
      ...
      <Container width="wide" className="relative">
        ...
        >
          ...
          <motion.p
            variants={FADE_UP}
            transition={TRANSITION_DEFAULT}
            className="mt-6 md:mt-8 font-display italic text-[clamp(20px,2.4vw,28px)] leading-snug text-marmorino max-w-2xl"
          >
            {hero.description}
          </motion.p>
        </motion.div>
