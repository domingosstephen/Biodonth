...
export function EspecialistasClosing() {
  const { closing } = ESPECIALISTAS_PAGE;
      ...
      <Container width="wide">
        ...
        >
          ...
          <motion.div variants={FADE_UP} transition={TRANSITION_DEFAULT} className="mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href={closing.secondaryCtaHref} className="group inline-flex items-center gap-2 font-body text-[15px] font-medium text-bronze hover:text-bronze-dark transition-colors duration-300 focus-visible:outline-2 focus-visible:outline-bronze focus-visible:outline-offset-4 py-2">
